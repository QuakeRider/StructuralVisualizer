...
**Status: complete (v0.6.0).** Spec: [curriculum/build-00-rework.md](curriculum/build-00-rework.md). M1 was built in v0.7.0, B7 was built early in v0.8.0 for classroom use, M2 was built in v0.9.0, B6 was built early in v0.10.0 (with the first stereonet), B8 was built early in v0.11.0 (with the fault laboratory and beach balls), and B9 was built early in v0.12.0 (with the fault-growth laboratory); next: lesson M3.
