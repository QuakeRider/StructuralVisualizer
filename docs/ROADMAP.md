...
**Status: complete (v0.6.0).** Spec: [curriculum/build-00-rework.md](curriculum/build-00-rework.md). M1 was built in v0.7.0, B7 was built early in v0.8.0 for classroom use, M2 was built in v0.9.0, and B6 was built early in v0.10.0 (with the first stereonet); next: lesson M3.
